...
import type { Board, Direction, GameState, TurnResult } from "./types.js";

export function has2048Tile(board: Board): boolean {
...
export function createNewGame(bestScore = 0, random = Math.random): GameState {
...
export function stepGame(state: GameState, direction: Direction, random = Math.random): TurnResult {
